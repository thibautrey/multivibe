...
export function TeamMachineConsent(){
 ...
 async function refresh(){try{const [c,s]=await Promise.all([api('/admin/team-machine/connection'),api('/admin/team-machine')]);setConnection(c);setState(s);}catch{setConnection(null);}}
