...
function fixture() {
  ...
  const resources={policy_revision:1,observed_at:new Date().toISOString(),free_storage_bytes:100*GiB,occupied_storage_bytes:0,free_host_memory_bytes:16*GiB,free_accelerator_memory_bytes:16*GiB};
  ...
  return {resolve:createLocalPreparationResolver(host,fetcher),policy,runtime,resources,variant,config,urls};
}
