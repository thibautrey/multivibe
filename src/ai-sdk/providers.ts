...
export const SDK_PROVIDERS: readonly SdkProviderDefinition[] = [
  ...
  QWEN_PROVIDER,
  MANUS_PROVIDER,
  { id: "openai", name: "OpenAI API", adapter: "compatible", baseURL: "https://api.openai.com/v1", modelsPath: "/models" },
  { id: "xai", name: "xAI API", adapter: "compatible", baseURL: "https://api.x.ai/v1", modelsPath: "/models" },
  { id: "mistral", name: "Mistral API", adapter: "compatible", baseURL: "https://api.mistral.ai/v1", modelsPath: "/models" },
  { id: "z-ai", name: "Z.AI API", adapter: "compatible", baseURL: "https://api.z.ai/api/paas/v4", modelsPath: "/models" },
