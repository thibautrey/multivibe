...
function environment(): NodeJS.ProcessEnv {
  return { MANAGED_CORE_JOURNAL_DIRECTORY: "/journal", MANAGED_CORE_PROVIDER_MANIFEST_FILE: "/config/accounts.json",
    MANAGED_CORE_INJECTOR_URL: "https://injector.internal", MANAGED_CORE_TLS_KEY_FILE: "/tls/key",
...
test("managed runtime has a required credential-free injector, TLS and durable journal configuration", () => {
