...
const grant:ExecutionGrant={version:2,audience:"multivibe-core-managed",attemptId:"attempt",reservationId:"reservation",routeVersionId:"route",providerId:"mistral",credentialRef:"account",model:"public/model",upstreamModel:"model",operation:"chat_completions",stream:false,bodySha256:"a".repeat(64),maximumOutputTokens:10,responseRecoveryKeyId:"test-key",responseRecoveryPublicKey:"A5wnJM5Y01mDWCA4MsbAtTGS_l8BI4-JNVWY_KRBH1I",responseRecoveryExpiresAt:120000,issuedAt:1000,expiresAt:2000};
