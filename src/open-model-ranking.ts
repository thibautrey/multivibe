...
export const catalogSorts = ['recommended', 'trending', 'downloads', 'newest', 'established'] as const;
...
export type OpenModelCatalog = { models: OpenModel[]; checkedAt: string; stale: boolean; source: string; version: string };
